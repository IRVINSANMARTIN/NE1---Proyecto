...
(5, 'Almacenamiento', 'icon-mobile'),
(6, 'Computadoras', 'icon-cat-computer'),
(7, 'Audio y bocinas', 'icon icon-earphones-alt'),
(8, 'Accesorios', 'icon icon-cat-shirt'),
(9, 'Cables', 'icon icon-cat-shirt'),
(10, 'Hardware', 'icon icon-desktop'),
(11, 'Software', 'icon icon-heart');
